...
![App Store](https://img.shields.io/badge/App%20Store-yak%C4%B1nda-999999?logo=appstore&logoColor=white)
...
> [!TIP]
> **DoneBot Google Play'de yayında** — [buradan indir](https://play.google.com/store/apps/details?id=com.todoapp.mobile). Ücretsiz, reklamsız, reklam kimliği yok. Güncel sürüm: **v1.1.1**. iOS sürümü yakında App Store'da.
...
**Yayında.** DoneBot, 12 kişilik kapalı betanın ardından Temmuz 2026'da Google Play'de üretime çıktı ve aktif olarak geliştirilmeye devam ediyor — güncel yayın sürümü `v1.1.1`. iOS sürümü hazırlanıyor. Bozuk bir şey mi buldun, bir özellik mi istiyorsun? Issue aç ya da **donebotapp@gmail.com** adresine yaz.
